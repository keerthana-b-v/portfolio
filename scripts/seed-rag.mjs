...
const chunks = [
  ...
  "Keerthana has hands-on RAG (Retrieval-Augmented Generation) experience across multiple shipped projects: an e-commerce customer support RAG agent, and this very portfolio chatbot you're talking to right now, which is itself a live RAG pipeline. Her legal document intelligence project is a separate, non-RAG system — it uses a fine-tuned Legal-BERT classifier, not retrieval.",
