    ...
    <div className="relative flex h-full w-full max-w-7xl flex-col items-center justify-center p-8 mx-auto overflow-hidden">
      <AnimatePresence mode="wait">
        ...
        >
          {/* Main Large Image */}
          <div
            className="absolute left-1/2 -translate-x-1/2 md:translate-x-0 md:left-10 top-0 h-[450px] w-[95%] md:w-[50%] rounded-[2.5rem] bg-contain bg-no-repeat bg-center bg-slate-50 border border-slate-100 shadow-2xl"
